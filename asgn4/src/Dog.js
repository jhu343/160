...
function renderDog() {
    ...
    rightFrontLegBottom.textureNum = -2;
        if (g_normalOn) {
      rightFrontLegBottom.textureNum = -3;
    }
    ...
    leftBackLegBottom.textureNum = -2;
        if (g_normalOn) {
      leftBackLegBottom.textureNum = -3;
    }
    ...
    rightBackLegBottom.textureNum = -2;
        if (g_normalOn) {
      rightBackLegBottom.textureNum = -3;
    }
